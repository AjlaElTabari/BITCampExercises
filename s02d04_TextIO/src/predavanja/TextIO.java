...
public class TextIO {
    ...
    public static void readFile(String fileName) {
        if (fileName == null) // Go back to reading standard input
            ...
            try {
                newin = new BufferedReader( new InputStreamReader(TextIO.class.getResourceAsStream(fileName)) );
            }
            catch (Exception e) {
    ...
    public static void writeFile(String fileName) {
        if (fileName == null)  // Go back to reading standard output
            ...
            PrintWriter newout;
            try {
                newout = new PrintWriter(new FileWriter(TextIO.class.getResource(fileName).toString()));
            }
            catch (Exception e) {
